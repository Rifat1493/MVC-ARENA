<template>
  <div id="play-field-info">
    <info-popup>
      ...
      <p>
        Plain instruction and method cards can be dragged to this area to start a new stack.
        ...
        cards of lower values.
      </p>
      <p>
        Plain instruction cards can also be dragged to the method stack. The value
        of the cards is added together (max of 9). The value of the method cards will
        update when the method stack changes value.
      </p>
      <p>
        Virus cards can be dragged onto any opponent stack that is highlighted red.
        ...
        Scan cards to restore your stacks full value
      </p>
