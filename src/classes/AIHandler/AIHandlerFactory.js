...
const CARD_ORDER = {
  standard: [
    "INSTRUCTION", "METHOD", "VARIABLE", "INTERFACE", "POLYMORPHISM", "GIT", "ERROR_HANDLING", "LOGGER", "SORT", "SEARCH",
  ...
  aggresive: [
    ...
    "DDOS", "STACK_UNDERFLOW", "VARIABLE", "INTERFACE", "POLYMORPHISM", "GIT", "ERROR_HANDLING", "LOGGER", "INSTRUCTION", "METHOD",
    "FIREWALL", "ANTIVIRUS", "SCAN"
  ],
  defensive: [
    "SORT", "SEARCH", "FIREWALL", "ANTIVIRUS", "SCAN", "METHOD", "VARIABLE", "INTERFACE", "POLYMORPHISM", "GIT", "ERROR_HANDLING", "LOGGER",
