...
const CARD_ORDER = {
  standard: [
    "INSTRUCTION", "METHOD", "VARIABLE", "INTERFACE", "POLYMORPHISM", "GIT", "ERROR_HANDLING", "SORT", "SEARCH",
  ...
  aggresive: [
    ...
    "DDOS", "STACK_UNDERFLOW", "VARIABLE", "INTERFACE", "POLYMORPHISM", "GIT", "ERROR_HANDLING", "INSTRUCTION", "METHOD",
    "FIREWALL", "ANTIVIRUS", "SCAN"
  ],
  defensive: [
    "SORT", "SEARCH", "FIREWALL", "ANTIVIRUS", "SCAN", "METHOD", "VARIABLE", "INTERFACE", "POLYMORPHISM", "GIT", "ERROR_HANDLING",
